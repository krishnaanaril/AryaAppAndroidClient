...
public class DataProvider extends ContentProvider {
    ...
    public static final String COL_CLOUDID="cloudId";
    ...
    public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.example.aarya.provider/messages");
    public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.example.aarya.provider/profile");
    ...
    static {
        ...
        uriMatcher.addURI("com.example.aarya.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("com.example.aarya.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("com.example.aarya.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("com.example.aarya.provider", "profile/#", PROFILE_SINGLE_ROW);
    }
    ...
    private static class DbHelper extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_NAME = "aarya.db";
