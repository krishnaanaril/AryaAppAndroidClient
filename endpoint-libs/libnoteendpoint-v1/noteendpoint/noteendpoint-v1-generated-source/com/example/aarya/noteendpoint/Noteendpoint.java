 ...
 * on 2014-05-18 at 09:41:44 UTC 
 * Modify at your own risk.
 */

package com.example.aarya.noteendpoint;
...
public class Noteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetNote extends NoteendpointRequest<com.example.aarya.noteendpoint.model.Note> {
    ...
    protected GetNote(java.lang.String id) {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.example.aarya.noteendpoint.model.Note.class);
   ...
   *
   * @param content the {@link com.example.aarya.noteendpoint.model.Note}
   * @return the request
   */
  public InsertNote insertNote(com.example.aarya.noteendpoint.model.Note content) throws java.io.IOException {
    InsertNote result = new InsertNote(content);
    initialize(result);
    return result;
  }

  public class InsertNote extends NoteendpointRequest<com.example.aarya.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected InsertNote(com.example.aarya.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "POST", REST_PATH, content, com.example.aarya.noteendpoint.model.Note.class);
    }
  ...
  public class ListNote extends NoteendpointRequest<com.example.aarya.noteendpoint.model.CollectionResponseNote> {
     ...
     */
    protected ListNote() {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.example.aarya.noteendpoint.model.CollectionResponseNote.class);
    }
   ...
   * @return the request
   */
  public UpdateNote updateNote(com.example.aarya.noteendpoint.model.Note content) throws java.io.IOException {
    UpdateNote result = new UpdateNote(content);
    initialize(result);
    return result;
  }

  public class UpdateNote extends NoteendpointRequest<com.example.aarya.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected UpdateNote(com.example.aarya.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "PUT", REST_PATH, content, com.example.aarya.noteendpoint.model.Note.class);
    }
